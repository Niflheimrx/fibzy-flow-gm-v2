...
function SurfTimer.Open()
	...
	do
		...
		SMPanels.SettingBox( { parent = panParent, x = bezel, y = bezel + ( padSize * 6 ), text = "Enable Mouse Smoothing", convar = "kawaii_mousesmoothing", tip = "Edits the Mose Sensitivity to a smoother value" } )
		SMPanels.SettingBox( { parent = panParent, x = bezel, y = bezel + ( padSize * 7 ), text = "Show Units in Center", convar = "kawaii_showkeys", tip = "Displays the unit velocity in the middle of the screenspace" } )
		SMPanels.SettingBox( { parent = panParent, x = bezel, y = bezel + ( padSize * 8 ), text = "Show Total Time", convar = "kawaii_showkeys", tip = "Messages you the total time of your run when completing a stage" } )
		SMPanels.SettingBox( { parent = panParent, x = bezel, y = bezel + ( padSize * 9 ), text = "Show Zones", convar = "kawaii_showzones", tip = "Toggles the checkpoint type on the saveloc plugin" } )
		SMPanels.SettingBox( { parent = panParent, x = bezel, y = bezel + ( padSize * 10 ), text = "Show Speed Stats", convar = "kawaii_showkeys", tip = "Toggles the visibility of Speed Stats when completing a zone" } )
		SMPanels.SettingBox( { parent = panParent, x = bezel, y = bezel + ( padSize * 11 ), text = "Enable Strafe Trainer", convar = "kawaii_strafetrainer", tip = "Enables the strafetrainer display" } )
		SMPanels.SettingBox( { parent = panParent, x = bezel, y = bezel + ( padSize * 12 ), text = "Suppress Viewpunch", convar = "kawaii_suppress_viewpunch", tip = "Enables the Suppress Viewpunch" } )
		SMPanels.SettingBox( { parent = panParent, x = bezel, y = bezel + ( padSize * 13 ), text = "Suppress Viewpunch Weapon", convar = "kawaii_suppress_viewpunch_wep", tip = "Enables the Weapon Suppress Viewpunch" } )
		SMPanels.SettingBox( { parent = panParent, x = bezel, y = bezel + ( padSize * 14 ), text = "CS:S Weapon Reload Loop", convar = "kawaii_css_reloading", tip = "Enables the CS:S Weapon Loop Reload" } )
